  ...
  return (
    <div className="p-4 border-t border-slate-700/50">
      ...
      >
        ...
        className="bg-gradient-to-r from-cyan-500 to-cyan-600 text-white rounded-xl
        px-4 py-4 font-medium hover:from-cyan-600 hover:to-cyan-700 transition-all disabled:opacity-50
